...
public class box2d_boxes2 extends PApplet {
...
public float swingSpeed(float tempY, float restY, float speed) {
...
public void makeEvil(){
  ...
  public FixtureDef makeFixture(PolygonShape sd) {
   // Define a fixture
...
public void display() {
    ...
    popMatrix();
    if (a>0.1f) {
    body.setAngularVelocity((v_a-0.3f)*0.9f);
    } else if (a<-0.1f) {
     body.setAngularVelocity((v_a+0.3f)*0.9f);
    }
  }
...
class Projectile extends Circle {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "box2d_boxes2" };
    if (passedArgs != null) {
